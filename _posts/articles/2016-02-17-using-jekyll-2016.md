...
image:
  feature: /images/using-jekyll-2016-feature.jpg
  teaser: /images/using-jekyll-2016-teaser.jpg
comments: true
featured: true
...
1. Link images in a post/page with just Markdown (e.g. /images/`![image](image-name.jpg)`).
...
To my knowledge there are no Jekyll plugin that do this, though some get close --- [Jekyll-Picture-Tag][picture-tag], [Jekyll-Responsive-Image][responsive-image], [Jekyll-Srcset][jekyll-srcset]. **Jekyll-Picture-Tag** does most of what I want (automatically size images from presets) with tags like {% raw %}`{% picture /images/image.jpg %}`{% endraw %}, which means I have to forgo linking to images with plain Markdown for now.
...
Now when a high resolution image is placed in `/images/_originals/` and `feature: /images/image.jpg` added to the YAML Front Matter of a page, this markup spits out automatically:

```html
<picture>
  <source /images/srcset="image-1600.jpg" media="(min-width: 1600px)">
  <source /images/srcset="image-1024.jpg" media="(min-width: 1024px)">
  <source /images/srcset="image-768.jpg" media="(min-width: 768px)">
  <source /images/srcset="image-600.jpg" media="(min-width: 600px)">
  <source /images/srcset="image-320.jpg">
  <img /images/src="image-320.jpg" class="page__hero-image" itemprop="image" alt="">
</picture>
```
...
billy_rick:
  ...
  avatar: /images/billy-rick-photo.jpg

cornelius_fiddlebone:
  name: Cornelius Fiddlebone
  email: cornelius@fiddlebone.com
  bio: "Jewel miner."
  avatar: /images/cornelius-fiddlebone-photo.jpg
```
