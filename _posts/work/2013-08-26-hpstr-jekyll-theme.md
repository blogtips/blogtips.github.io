...
image: 
  feature: /images/hpstr-preview-feature-2015.jpg
  teaser: /images/hpstr-preview-teaser-2015.png
  thumb: /images/hpstr-preview-th-2015.png
...
Currently there are two Grunt tasks: one to build and optimize and the other to watch for changes to any LESS and JavaScript files. For now you need to run `grunt` to rebuild the CSS, concatenate JavaScript files, and optimize /images/.jpg, /images/.png, and .svg files in the `images/` folder. And then run `jekyll build` to pull these changes in when developing locally. 
